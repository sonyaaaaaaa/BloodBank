...
<div class="vh-100">
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Заполните форму для пациента</strong></h3>
        </div>
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="addPatient.php" method="POST" class="mbr-form form-with-styler mx-auto" >
                    <div class="dragArea row">
						...
						<div class="col-md-12">
							...
							//из данных собираем соответствующие переменные
								...
								mysqli_query($db, "INSERT INTO `patient`(`middle_name`, `first_name`, `last_name`, `age`, `blood_type`, `rh`, `tel`)
