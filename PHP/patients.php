    ...
    <div class="container-fluid">
        <div class="">
            <div class="title col-md-12 col-lg-12">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2"><strong>Пациенты</strong></h3>
            </div>
				...
				<table border="2" cellpadding="5" align-center >
					...
					<?php
						while ($patients = mysqli_fetch_assoc($result))
						{
							?>
							<tr>
								<td><?php echo $patients['middle_name']; ?></td>
								<td><?php echo $patients['first_name']; ?></td>
								<td><?php echo $patients['last_name']; ?></td>
								<td><?php echo $patients['age']; ?></td>
								<td><?php echo $patients['blood_type']; ?></td>
								<td><?php echo $patients['rh']; ?></td>
								<td><?php echo $patients['tel']; ?></td>
							</tr>
							<?php
						}
					?>
